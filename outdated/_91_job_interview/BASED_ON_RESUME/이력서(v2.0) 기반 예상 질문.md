...
<details>
    <summary><b>CI는 뭐고 CD는 뭔가요? 1️⃣</b></summary>
...
- CD(Continuous Delivery, Deployment)
  - 지속적인 배포(또 다른 의미의 "CD": Continuous Deployment)란 개발자의 **변경 사항을 리포지토리에서 고객이 사용 가능한 프로덕션 환경까지 자동으로 릴리스하는 것**을 의미합니다. 
  - 이는 애플리케이션 제공 속도를 저해하는 수동 프로세스로 인한 운영팀의 프로세스 과부하 문제를 해결합니다. 지속적인 배포는 파이프라인의 다음 단계를 자동화함으로써 지속적인 서비스 제공의 장점을 활용합니다.
...
<details>
    <summary><b>애자일 스크럼?</b></summary>

- 짧은 주기의 개발 단위를 반복하여 큰 프로젝트를 나가는 방법
- 핵심은 `협력`과 `피드백`
